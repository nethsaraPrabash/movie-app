...
const ForgotPassword = ({ open, handleClose }) => (
  <Dialog open={open} onClose={handleClose}>
    ...
    <DialogActions>
      ...
      <Button onClick={() => alert("This function is not implemented because this is a demo ")}>Submit</Button>
    </DialogActions>
  </Dialog>
);
...
const Login = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (username === loginCredentials.username && password === loginCredentials.password) {
      ...
      alert('Invalid username or password \nPlease enter username = "root" and password = "root"');
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <Typography sx={{ textAlign: 'center' }}>
              ...
              <Link
                component="button"
                type="button"
                onClick={() => alert('This functionality is not implemented beacause this is a demo')}
                variant="body2"
                sx={{ alignSelf: 'center' }}
              >
                Sign up
